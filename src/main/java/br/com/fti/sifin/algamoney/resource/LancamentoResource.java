package br.com.fti.sifin.algamoney.resource;
...
import br.com.fti.sifin.algamoney.service.LancamentoService;
...
import br.com.fti.sifin.exceptionhandler.SifinExceptionHandler.Erro;
...
public class LancamentoResource {
	...
	public ResponseEntity<Lancamento> criar(@Valid @RequestBody Lancamento lancamento, HttpServletResponse response) {
		...
		publisher.publishEvent(new RecursoCriadoEvent(this, response, lancamentoSalvo.getCodigo().toString()));

package br.com.fti.sifin.exceptionhandler;
...
@ControllerAdvice
public class SifinExceptionHandler extends ResponseEntityExceptionHandler {
	...
	//Criar lista de erros validado pelo Bean Validation
